...
class AssociateAdvanceController extends Controller
{
    ...
    public function index()
    {
        ...
        return view(
            'payment.associate-advance.index',
            compact('advances')
        );
    }
    ...
    public function create()
    {
        ...
        return view(
            'payment.associate-advance.create',
            compact('associates')
        );
    }

    public function store(
        AssociateAdvanceRequest $request
    ) {
        $this->service->store(
            $request->validated()
        );
        ...
        return redirect()
            ->route(
                'admin.associate-advances.index'
            )
            ->with(
                'success',
    ...
    public function edit($id)
    {
        ...
        return view(
            'payment.associate-advance.edit',
            compact(
                'advance',
                'associates'
            )
