...
@section('content')
    <div class="container-fluid mt-4">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-3">
            <div>
                <h3 class="fw-bold mb-1">My Downline</h3>
                <small class="text-muted">Manage My Downline Associates</small>
            </div>
                ...
                <form method="GET">
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col-md-3 d-flex align-items-end gap-2">
                            ...
                            <a href="{{ route('associate-panel.my-downline') }}" class="btn btn-secondary">
                                Reset
                            </a>
